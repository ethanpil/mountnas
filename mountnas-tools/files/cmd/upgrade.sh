...
EOF
	...
	if [ "$ec" != 0 ]; then
		...
		for f in boot/vmlinuz-lts boot/initramfs-lts boot/modloop-lts world.base alpine.base rc.base cmdline.base ldlinux.c32 boot/amd-ucode.img boot/intel-ucode.img; do
			rm -f "$BOOTMNT/$f.new"
		done
